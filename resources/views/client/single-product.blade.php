                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="one">
                            <a class="venobox" href="img/single-product/bg-1.jpg" data-gall="gallery" title="">
                                <img src="{{asset($product->image)}}" alt="" width="570px" height="550px" style="display:block; width: 553px; height: 553px;">
                    ...
                    <div class="single-banner">
                        <div class="product-wrapper">
                            <a href="{{route('shop.show',$product->id)}}" class="single-banner-image-wrapper">
                                <img alt="" src="{{asset($product->image)}}"  style="display:block; width: 250px; height: 250px;">
                                                <img style="position: absolute;
                                                margin: auto;
                                                top: 0;
                                                left: 0;
